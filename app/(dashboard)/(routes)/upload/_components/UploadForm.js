...
const UploadForm = () => {
    ...
    return (
        <div className='text-center'>
            ...
            <button disabled={!file} className={`${!file ? 'opacity-30 cursor-not-allowed' : ''} p-2 bg-primary text-white w-full md:w-[30%] lg:w-[15%] rounded-full mt-5 disabled:bg-gray-700`}>Upload</button>
        </div>
    )
}
